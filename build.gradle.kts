        ...
        File(projectDir, "Settings.editme")
            .writeText(
                """
                   ...
                   |   # "PD", "NoPD", "PD(Flx>N%)", "Fighter", "AvoidShields", "TargetShields", "NoFighters", "Hold(Flx>N%)",
                   |   # "ConserveAmmo", "Opportunist", "TgtShields+", "AvdShields+", "AvoidArmor"
                   |   # Experimental tags (mostly untested): "TgtShields+", "AvdShields+", "AvoidArmor"
                   |   "tagList" : ["PD", "NoPD", "PD(Flx>50%)", "Fighter", "AvoidShields", "AvoidArmor", "TargetShields", "NoFighters", "Hold(Flx>90%)", "Hold(Flx>75%)", "Hold(Flx>50%)", "ConserveAmmo", "Opportunist"]
                   |  

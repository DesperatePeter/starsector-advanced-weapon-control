...
object Settings : SettingsDefinition() {
    ...
    // mode/suffix params
    val opportunistKineticThreshold = addSetting<Float>("opportunist_kineticThreshold", 0.5f, false)
    val opportunistHEThreshold = addSetting<Float>("opportunist_HEThreshold", 0.15f, false)
    val ventFluxThreshold = addSetting<Float>("vent_flux", 0.75f, false)
    val aggressiveVentFluxThreshold = addSetting<Float>("aggressiveVent_flux", 0.25f, false)
    val ventSafetyFactor = addSetting<Float>("vent_safetyFactor", 2f, false)
    val aggressiveVentSafetyFactor = addSetting<Float>("aggressiveVent_safetyFactor", 0.25f, false)
    ...
    val strictBigSmall = addSetting<Boolean>("strictBigSmallShipMode", true, tryLunar = false)
    val targetShieldsThreshold = addSetting<Float>("targetShields_threshold", 0.2f, false)
    val avoidShieldsThreshold = addSetting<Float>("avoidShields_threshold", 0.5f, false)
